...
export const ProjectsShowcaseSection = (): JSX.Element => {
  ...
  return (
    <section className="relative w-[80%] max-w-[1500px] px-6 md:px-16 py-16 flex flex-col items-center">
         ...
         <img
          ...
          src="https://c.animaapp.com/mc1n4zn94AUOLo/img/ia---ema-2-5.png"
            />
          <h2 className="font-black text-white text-[2.5rem] w-full text-center md:text-left [font-family:'Roboto',Helvetica] self-start">
            Réalisations
          </h2>
